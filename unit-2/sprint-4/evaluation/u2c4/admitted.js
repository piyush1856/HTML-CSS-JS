...
let acceptFromLS = JSON.parse(localStorage.getItem("admission-accepted"));
displayTable(acceptFromLS);

function displayTable(acceptFromLS){
    document.querySelector("tbody").innerHTML = "";

    acceptFromLS.forEach(function(elem){
